...
// Logic for Open Chatbot 
(async function main() {
  try {
    // Configures puppeteer (Its 3rd party service)
    ...
    //Loops through cycle of sending message (One by one and single user)
...
// If delayed during open ChatBot
function delay(time) {
